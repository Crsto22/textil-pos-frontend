...
interface UsuarioReporteFilterOption {
  key: UsuarioReporteFiltro
  label: string
}

interface UsuariosReporteFiltersProps {
  activeFilter: UsuarioReporteFiltro
  filterOptions: UsuarioReporteFilterOption[]
  onFilterChange: (filter: UsuarioReporteFiltro) => void
...
export function UsuariosReporteFilters({
  activeFilter,
  filterOptions,
  onFilterChange,
  selectedSucursalId,
