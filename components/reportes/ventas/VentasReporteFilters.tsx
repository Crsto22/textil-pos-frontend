...
interface VentaReporteFilterOption {
  key: VentaResumenReporteFiltro
  label: string
}
...
interface VentasReporteFiltersProps {
  activeFilter: VentaResumenReporteFiltro
  filterOptions: VentaReporteFilterOption[]
  onFilterChange: (filter: VentaResumenReporteFiltro) => void
  isAdmin: boolean
...
export function VentasReporteFilters({
  activeFilter,
  filterOptions,
  onFilterChange,
  isAdmin,
