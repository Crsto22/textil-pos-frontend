...
interface ProductoReporteFilterOption {
  key: ProductoReporteFiltro
  label: string
}
...
interface ProductosReporteFiltersProps {
  activeFilter: ProductoReporteFiltro
  filterOptions: ProductoReporteFilterOption[]
  onFilterChange: (filter: ProductoReporteFiltro) => void
  isAdmin: boolean
...
export function ProductosReporteFilters({
  activeFilter,
  filterOptions,
  onFilterChange,
  isAdmin,
