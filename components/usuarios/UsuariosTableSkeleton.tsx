...
interface UsuariosTableSkeletonProps {
  rows?: number
}

function UsuariosTableSkeletonComponent({ rows = 6 }: UsuariosTableSkeletonProps) {
...
export const UsuariosTableSkeleton = memo(UsuariosTableSkeletonComponent)
