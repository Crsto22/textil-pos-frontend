...
function ComprobantesPaginationComponent({
  totalElements,
  totalPages,
  page,
  onPageChange,
}: ComprobantesPaginationProps) {
...
export const ComprobantesPagination = memo(ComprobantesPaginationComponent)
