...
export function VentasHistorialFilters({
  ...
  const comprobanteTabOptions = useMemo(
    () => [
      ...
      ...getComprobanteTipoOptions(
        filters.comprobante === "TODOS" ? null : filters.comprobante
      )
        .filter((option) =>
      ...
      <div className="flex flex-col gap-4">
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-muted-foreground">Comprobantes</label>
            <div className="overflow-x-auto pb-1">
              <Tabs
                ...
                className="w-full"
              >
                <TabsList className="h-auto min-w-max gap-1 rounded-xl border border-border/60 bg-muted/40 p-1">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="space-y-1">
              ...
              />
              {errorClientes && (
                <p className="text-[11px] text-red-500">{errorClientes}</p>
              )}
            </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <button
                ...
                className="inline-flex h-10 items-center justify-center rounded-lg bg-rose-600 px-4 text-xs font-semibold text-white transition-colors hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {reportPdfLoading ? "Generando PDF..." : "Reporte PDF"}
              </button>
              <button
                type="button"
                onClick={onDownloadReport}
                disabled={reportLoading}
                className="inline-flex h-10 items-center justify-center rounded-lg bg-[#16813f] px-4 text-xs font-semibold text-white transition-colors hover:bg-[#156e37] disabled:cursor-not-allowed disabled:opacity-60"
              >
