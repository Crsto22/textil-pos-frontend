  ...
  try {
    ...
    try {
      backendRes = await fetch(
        `${BACKEND_URL}/api/nota-credito/${encodeURIComponent(id)}/sunat/xml`,
        {
          method: "GET",
          headers,
          cache: "no-store",
    ...
    const contentDisposition =
      ...
      `attachment; filename="nota_credito_${encodeURIComponent(id)}.xml"`
    ...
    console.error("[NOTA_CREDITO/SUNAT/XML]", error)
