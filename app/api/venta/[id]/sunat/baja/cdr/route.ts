...
export async function GET(
  ...
  try {
    ...
    const backendUrl = new URL(
      `${BACKEND_URL}/api/venta/${encodeURIComponent(id)}/sunat/baja/cdr`
    )
    if (formato) {
    ...
    const contentDisposition =
      ...
      `attachment; filename="cdr_baja_venta_${encodeURIComponent(id)}.${fallbackExt}"`
    ...
    console.error("[VENTA/SUNAT/BAJA/CDR]", error)
