...
export async function GET(
  ...
  try {
    ...
    try {
      backendRes = await fetch(`${BACKEND_URL}/api/venta/${encodeURIComponent(id)}/sunat/xml`, {
        method: "GET",
        headers,
        cache: "no-store",
      })
    ...
    const contentDisposition =
      ...
      `attachment; filename="venta_${encodeURIComponent(id)}.xml"`
    ...
    console.error("[VENTA/SUNAT/XML]", error)
