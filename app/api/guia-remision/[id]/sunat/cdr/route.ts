...
export async function GET(
  ...
  try {
    ...
    const backendUrl = new URL(
      `${BACKEND_URL}/api/guia-remision/${encodeURIComponent(id)}/sunat/cdr`
    )
    if (formato) {
    ...
    const contentDisposition =
      ...
      `attachment; filename="cdr_guia_remision_${encodeURIComponent(id)}.${fallbackExt}"`
    ...
    console.error("[GUIA-REMISION/SUNAT/CDR]", error)
